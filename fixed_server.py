#!/usr/bin/env python3
"""
Servidor simplificado para CardioAI - Versão corrigida
"""
...
class ModelService:
    ...
    def initialize_models(self):
        ...
        X_demo = np.random.randn(1000, 5000)  # 1000 amostras, 5000 features
    ...
    def predict(self, model_name, data):
        ...
        try:
            ...
            if processed_data.ndim > 1 and processed_data.shape[0] > 1:
                # Dados 2D - achatar para sklearn
...
async def analyze_ecg_image(
    ...
    try:
        ...
        if not file:
            ...
            logger.info("Arquivo não enviado, usando dados simulados")
